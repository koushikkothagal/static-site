...
function CourseData() {
	...
	this.courses = [
				...
				{ slNo: 13, code: 'corejs_jsfordev', topic: 'corejs', name: 'JavaScript for Developers',
						...
						'level': 'Beginner', 
						'maxPoints': 710,
						'img': '/assets/images/corejs_jsfordev_thumb.png',
						'tags': ['Javascript', 'Core']
				},
                { slNo: 14, code: 'corejs_scopesclosures', topic: 'corejs', name: 'Scopes and Closures In-depth',
	...
	for (var i=0; i< this.courses.length; i++) {
        ...
        var topic = this.topicMap[this.courses[i].topic];
        topic.numberOfCourses = topic.numberOfCourses || 0;
        topic.courses = topic.courses || []; 
        topic.numberOfCourses++;
        topic.courses.push(this.courses[i]);
	}
